...
-- Colors
Ruthless.Theme = {
    Primary = Color3.fromRGB(0, 132, 255),       -- Ocean blue
    Secondary = Color3.fromRGB(0, 81, 158),      -- Darker ocean blue
    Background = Color3.fromRGB(20, 20, 30),     -- Dark background
    Text = Color3.fromRGB(255, 255, 255),        -- White text
    Accent = Color3.fromRGB(0, 162, 255)         -- Bright ocean accent
}

-- Create main screen GUI
local screenGui = Instance.new("ScreenGui")
screenGui.Name = "RuthlessLib"
...
mainFrame.BackgroundColor3 = Ruthless.Theme.Background
...
uiStroke.Color = Ruthless.Theme.Primary
...
gradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Ruthless.Theme.Primary),
    ColorSequenceKeypoint.new(1, Ruthless.Theme.Secondary)
}
...
titleBar.BackgroundColor3 = Ruthless.Theme.Primary
...
titleText.TextColor3 = Ruthless.Theme.Text
titleText.Text = "Ruthless UI Library"
...
closeButton.TextColor3 = Ruthless.Theme.Text
closeButton.Text = "X"
closeButton.Font = Enum.Font.GothamBold
closeButton.TextSize = 14
closeButton.Parent = titleBar

-- Side tab container (vertical on the left)
...
-- Create tab function
function Ruthless:CreateTab(name)
    local tabButton = Instance.new("TextButton")
    tabButton.Name = name .. "TabButton"
    tabButton.Size = UDim2.new(1, -10, 0, 30)
    tabButton.Position = UDim2.new(0, 5, 0, (#self.Tabs * 35))
    tabButton.BackgroundColor3 = Ruthless.Theme.Primary
    tabButton.BackgroundTransparency = 0.7
    tabButton.BorderSizePixel = 0
    tabButton.TextColor3 = Ruthless.Theme.Text
    tabButton.Text = name
...
-- Switch tab function
function Ruthless:SwitchTab(tab)
    if self.CurrentTab then
        self.CurrentTab.Frame.Visible = false
        self.CurrentTab.Button.BackgroundTransparency = 0.7
    end
...
function Ruthless:CreateButton(tab, name, callback)
    local button = Instance.new("TextButton")
    button.Name = name
    button.Size = UDim2.new(1, -10, 0, 30)
    button.Position = UDim2.new(0, 5, 0, #tab.Elements * 38)
    button.BackgroundColor3 = Ruthless.Theme.Primary
    button.BackgroundTransparency = 0.8  -- Transparent background
    button.BorderSizePixel = 0
    button.TextColor3 = Ruthless.Theme.Text
    button.Text = name
    ...
    buttonStroke.Color = Ruthless.Theme.Primary
...
function Ruthless:CreateToggle(tab, name, default, callback)
    ...
    toggleButton.BackgroundColor3 = default and Ruthless.Theme.Accent or Color3.fromRGB(80, 80, 80)
    ...
    toggleStroke.Color = Ruthless.Theme.Primary
    ...
    toggleIndicator.BackgroundColor3 = Ruthless.Theme.Text
    ...
    toggleLabel.TextColor3 = Ruthless.Theme.Text
    ...
    toggleButton.MouseButton1Click:Connect(function()
        ...
        if isToggled then
            ...
            TweenService:Create(toggleButton, TweenInfo.new(0.2), {BackgroundColor3 = Ruthless.Theme.Accent}):Play()
        else
...
function Ruthless:CreateSlider(tab, name, min, max, default, callback)
    ...
    sliderLabel.TextColor3 = Ruthless.Theme.Text
    ...
    trackStroke.Color = Ruthless.Theme.Primary
    ...
    sliderFill.BackgroundColor3 = Ruthless.Theme.Primary
    ...
    sliderButton.BackgroundColor3 = Ruthless.Theme.Text
...
function Ruthless:CreateDropdown(tab, name, options, default, callback)
    ...
    dropdownButton.BackgroundColor3 = Ruthless.Theme.Primary
    dropdownButton.BackgroundTransparency = 0.7
    dropdownButton.BorderSizePixel = 0
    dropdownButton.TextColor3 = Ruthless.Theme.Text
    ...
    dropdownArrow.TextColor3 = Ruthless.Theme.Text
    dropdownArrow.Text = "▼"
    ...
    optionsFrame.BackgroundColor3 = Ruthless.Theme.Background
    ...
    optionsStroke.Color = Ruthless.Theme.Primary
    ...
    for i, option in ipairs(options) do
        ...
        optionButton.BackgroundColor3 = Ruthless.Theme.Primary
        optionButton.BackgroundTransparency = 0.7
        optionButton.BorderSizePixel = 0
        optionButton.TextColor3 = Ruthless.Theme.Text
        ...
        optionStroke.Color = Ruthless.Theme.Primary
